      ...
      <div className="reveal hover-lift mx-auto grid max-w-7xl items-center gap-10 rounded-[2.5rem] border border-[var(--border)] bg-[rgba(255,251,245,0.72)] p-6 shadow-[var(--shadow-card)] sm:p-8 lg:grid-cols-[0.86fr_1.14fr] lg:p-10">
        ...
        <div className="max-w-3xl lg:pl-6">
          ...
          <div className="mt-7 space-y-5 text-[1.04rem] leading-8 text-[var(--muted)] sm:text-lg">
            ...
            <p>
              В работе я не использую шаблонный подход.
Аппаратное восстановление — это работа с исходным состоянием бровей, причинами повреждения и грамотной тактикой отращивания.
            </p>
             <p>
              Задача процедуры не замаскировать проблему временным эффектом, а создать условия для постепенного восстановления бровей за счёт системной работы с волосом и кожей.
            </p>
          </div>
