...
const faqs = [
  {
    ...
    answer:
      'Это онлайн-консультация / обучение в удобном формате. Мы заранее согласуем платформу: Telegram, Zoom или другой вариант, разбираем технику и рекомендации. После встречи вы получаете практическое видео с отработкой на модели.',
  },
  {
    question: 'Что я получу после онлайн-встречи?',
    answer:
      'После онлайн-встречи вы получаете рекомендации, разбор техники и практическое видео, чтобы было проще внедрить услугу в работу.',
  },
  {
